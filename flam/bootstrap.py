...
def bootstrap(main, argv=None, name=None, version=None, config=None, **kwargs):
    """Bootstrap a main function with command line and configuration options.

    :param argv: sys.argv (or equivalent)
    :param name: Name of the application.
    :param version: Version number to provide to optparse.
    :param config: flam.config.Configuration object or filename.
    :param kwargs: Passed to main.
    :returns: Result of main.
    """
