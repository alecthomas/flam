...
def main(from_file=None):
    """Discover and run tests for the callers package using nose."""
    if from_file is None:
        from_file = os.path.dirname(sys._getframe(1).f_code.co_filename)
    args = sys.argv + ['--with-doctest', '--doctest-extension=rst', from_file]
    nose.main(argv=args)
